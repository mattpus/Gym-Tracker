...
final class WorkoutsUseCaseFactory: Sendable {
    ...
    func makeEditWorkoutUseCase() -> WorkoutEditing {
        EditWorkoutUseCase(repository: workoutRepository)
    }
    ...
    func makeDeleteWorkoutHistoryUseCase() -> WorkoutHistoryDeleting {
        DeleteWorkoutHistoryUseCase(repository: workoutRepository)
    }

    func makeExportWorkoutHistoryCSVUseCase() -> WorkoutHistoryExporting {
        ExportWorkoutHistoryCSVUseCase(repository: workoutRepository)
    }
