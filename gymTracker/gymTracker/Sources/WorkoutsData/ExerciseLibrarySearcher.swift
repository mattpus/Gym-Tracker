...
public final class LocalExerciseLibrarySearcher: WorkoutExerciseLibrarySearching {
	...
	public func search(query: String, completion: @escaping (WorkoutExerciseLibrarySearching.Result) -> Void) {
