...
public protocol RecoveryPresenterOutput: AnyObject {
    func display(_ viewModel: AnalyticsRecoveryViewModel)
}
...
public final class RecoveryPresenter {
    ...
    public func present(_ insight: RecoveryInsight) {
        let muscleStatuses = insight.muscleGroupRecovery.map { status -> MuscleAnalyticsRecoveryViewModel in
            ...
            return MuscleAnalyticsRecoveryViewModel(
        ...
        let viewModel = AnalyticsRecoveryViewModel(
