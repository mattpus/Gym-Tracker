...
struct ExerciseSelectionView: View {
    ...
    let onExerciseSelected: (WorkoutsDomain.Exercise) -> Void
...
private struct MuscleGroupTag: View {
    let muscleGroup: ExerciseLibraryDomain.MuscleGroup
    let isPrimary: Bool
...
extension ExerciseLibraryDomain.MuscleGroup {
...
extension ExerciseLibraryDomain.EquipmentType {
    var displayName: String {
        switch self {
