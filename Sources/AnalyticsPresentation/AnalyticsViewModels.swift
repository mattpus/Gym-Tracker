...
public struct WorkoutFrequencyViewModel: Equatable {
...
public struct MuscleDistributionViewModel: Equatable {
...
public struct VolumeProgressionViewModel: Equatable {
...
public struct WeightProgressionViewModel: Equatable {
...
public struct RecoveryViewModel: Equatable {
    public let muscleStatuses: [MuscleRecoveryViewModel]
    public let readyToTrainText: String
    public let needsRestText: String
    
    public init(muscleStatuses: [MuscleRecoveryViewModel], readyToTrainText: String, needsRestText: String) {
...
public struct MuscleRecoveryViewModel: Equatable {
    public let muscleGroup: String
