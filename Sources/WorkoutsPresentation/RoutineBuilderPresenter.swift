...
public final class RoutineBuilderPresenter {
	private let routineBuilderView: RoutineBuilderView
	...
	private let exerciseSearch: ExerciseLibrarySearching
	
	private var routine = Routine(name: "", exercises: [])
	
	public init(
		routineBuilderView: RoutineBuilderView,
		...
		exerciseSearch: ExerciseLibrarySearching
	) {
